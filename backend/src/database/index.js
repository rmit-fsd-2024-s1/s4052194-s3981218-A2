...
async function seedData() {
  db.product.bulkCreate([
    ...
    {
      product_id: 11,
      product_name: "Organic Vegetable Seeds.png",
      product_price: 2.99,
      product_stock: 1,
      product_image: "/Organic Vegetable Seeds.png"  },
    {
      product_id: 12,
      product_name: "Gardening Gloves.png",
      product_price: 7.99,
      product_stock: 1,
      product_image: "/Gardening Gloves.png"  },
    {
      product_id: 13,
      product_name: "Pruning Shears.png",
      product_price: 12.99,
      product_stock: 10,
      product_image: "/Pruning Shears.png"  },
    {
      product_id: 14,
      product_name: "Hand Trowel.png",
      product_price: 6.99,
      product_stock: 10,
      product_image: "/Hand Trowel.png"  },
    {
      product_id: 15,
      product_name: "Seedling Trays.png",
      product_price: 4.99,
      product_stock: 10,
